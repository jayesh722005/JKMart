...
import p5_img from '../assets/5.avif'
import p6_img from '../assets/3.jfif'
import p7_img from '../assets/4.avif'
import p8_img from  '../assets/2.webp'
...
let new_collections = [
     { id: 5, name: "T-Shirt", category: "men", image: p1_img, new_price: 45.0, old_price: 70.0 },
        { id: 6, name: "Dress", category: "women", image: p11_img, new_price: 85.0, old_price: 130.0 },
        ...
        { id: 9, name: "Shirt", category: "men", image: p5_img, new_price: 70.0, old_price: 110.0 },
        ...
        { id: 12, name: "Gown", category: "women", image: p8_img, new_price: 99.0, old_price: 160.0 },
]
