...
import p17_img from '../assets/p5.png'
// import p17_img from '../assets/p1.jpg'
import p18_img from '../assets/men2.jpg'
import p19_img from '../assets/p9.png'
...
let all_product = [
    ...
    { id: 2, name: "Jeans", category: "men", image:p9_img, new_price: 60.0, old_price: 90.5 },
    ...
    { id: 5, name: "Shirt", category: "men", image: p5_img, new_price: 45.0, old_price: 70.0 },
    { id: 6, name: "Dress", category: "women", image: p6_img, new_price: 85.0, old_price: 130.0 },
    { id: 7, name: "Lower", category: "men", image: p7_img, new_price: 95.0, old_price: 150.0 },
    { id: 8, name: "Leggings", category: "women", image: p8_img, new_price: 55.0, old_price: 100.0 },
    { id: 9, name: "Shirt", category: "men", image: p2_img, new_price: 70.0, old_price: 110.0 },
    ...
    { id: 15, name: "Tshirt", category: "men", image: p15_img, new_price: 78.0, old_price: 115.0 },
    { id: 16, name: "Skirt", category: "women", image:p16_img, new_price: 73.0, old_price: 110.0 },
   { id: 17, name: "Tshirt", category: "men", image: p17_img, new_price: 79.0, old_price: 125.0 },
   { id: 18, name: " paint-shirt", category: "men", image: p18_img, new_price: 179.0, old_price: 225.0 },
    { id: 19, name: "Top", category: "women", image: p19_img, new_price: 52.0, old_price: 85.0 },
    ...
    { id: 24, name: "Trousers", category: "kid", image:p25_img , new_price: 76.0, old_price: 120.0 },
    { id: 25, name: "Tank Top", category: "kid", image: p27_img, new_price: 49.0, old_price: 80.0 },
   
    { id: 26, name: "Formal Pants", category: "kid", image:p29_img, new_price: 98.0, old_price: 160.0 },

    { id: 27, name: "Leather Jacket", category: "kid", image: p31_img, new_price: 150.0, old_price: 250.0 },

    { id: 28, name: "Gym Shorts", category: "kid", image: p33_img, new_price: 55.0, old_price: 90.0 },
  
    { id:29, name: "Casual Blazer", category: "kid", image: p35_img, new_price: 105.0, old_price: 170.0 },
